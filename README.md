...
| tls                        | null      | An object containing options to pass to [tls.connect](http://nodejs.org/api/tls.html#tls_tls_connect_port_host_options_callback) to set up a TLS connection to Redis (if, for example, it is set up to be accessible via a tunnel). A TLS connection will still be attempted even if this value is an empty options object (e.g. `tls: {}`).                                                                                                                                                                                                                                                                                                                                            |
